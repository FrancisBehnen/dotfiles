...
- **Admin vs non-admin:** The `scripts/setup.sh` script detects admin rights and adjusts installation. Homebrew formulas work without admin; some casks and MacPorts require admin.
...
- Do NOT assume admin rights — check or make operations conditional
